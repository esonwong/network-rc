...
const defaultChannelList = [
  ...
  },
  {
    ...
    keyboard: [
      { name: "j", positive: true, method: "step" },
      { name: "l", positive: false, method: "step" },
      { name: "p", reset: true },
    ],
    gamepad: [{ name: "axe-2", positive: true, method: "step" }],
    valuePostive: 2,
    valueNegative: -2,
    valueReset: 0,
  },
  {
    ...
    keyboard: [
      { name: "i", positive: true, method: "step" },
      { name: "k", positive: false, method: "step" },
      { name: "p", reset: true },
    ],
    gamepad: [{ name: "axe-2", positive: true, method: "step" }],
    valuePostive: 2,
