...
const defaultChannelList = [
  { name: '电调', pin: 13, type: 'pwm', method: 'default', ui: 'slider', uiPostion: { x: 0, y:0 }, keyboardPositive: 'w', keyboardNegative: 's', gamepadPositive: ['axe-1', 'button-7'], gamepadNegative: [`button-6`], valuePostive: 1, valueNegative: -1, valueReset: 0 },
]
